...
public class PermissionSettingPage {
    ...
    private static Intent xiaomi(Context context) {
        ...
        intent.setClassName("com.miui.securitycenter", "com.miui.permcenter.permissionMap.AppPermissionsEditorActivity");
        if (hasIntent(context, intent)) return intent;

        intent.setClassName("com.miui.securitycenter", "com.miui.permcenter.permissionMap.PermissionsEditorActivity");
        return intent;
    }
